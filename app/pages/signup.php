...
<main class="form-signin w-100 m-auto">
  <form method="post">
    ...
    <?php endif; ?>
    <div class="form-floating">
      <input value="<?=old_value('email')?>" name="email" type="email" class="form-control mb-2" id="floatingInput" placeholder="Email">
    ...
    <?php if(!empty($errors['confirm_password'])): ?>
      <div class="text text-danger"><?=$errors['confirm_password']?></div>
    <?php endif; ?>

    <div>Already have an account ? <a href="<?=ROOT?>/login">Login here</a></div>
