<?php
  ...
  $section = $url[1] ?? 'dashboard'; // admin/users => users; admin/categories => categories; admin/posts => posts; admin => dashboard
  $action = $url[2] ?? 'view'; 
  $id = $url[3] ?? 0;

  $filename = "../app/pages/admin/".$section.".php"; // example -> ..app/pages/admin/users.php;
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" aria-current="page" href="<?=ROOT?>/admin">
