...
<main class="form-signin w-100 m-auto">
  <form method="post">
    ...
    <div class="form-floating">
      <input value="<?=old_value('email')?>" type="email" class="form-control mb-2" id="floatingInput" placeholder="name@example.com" name="email">
    ...
    <div class="form-floating">
      ...
      <div>Don't have an account ? <a href="<?=ROOT?>/signup">Signup here</a></div>
